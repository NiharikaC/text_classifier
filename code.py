...
with open('/Users/admin/Anaconda3/Lib/site-packages/naiveBayesClassifier/data/data1.txt') as json_data:
...
sent_1 = "Some counties provide this information real time, which is a significant aid to young general contractors, real estate developers like myself"
sent_2 = "narendra modi was great politician"
